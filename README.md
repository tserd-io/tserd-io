...
An open-source AI Platform that aims at building a modular LLM evaluation and workflow optimizer to regulate and govern agents. It can easily plug into your existing provider and create a full workflow trace of prompts, decisions, failures, cost and performance for your LLM calls. [WIP]: more features will be added over time
